<!-- Navbar -->
<nav class="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-30 border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex md:hidden items-center">
                <button onclick="toggleMobileSidebar()" class="p-2 text-gray-600 hover:text-primary rounded-lg hover:bg-gray-100">
